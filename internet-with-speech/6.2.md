...
works. If you use JAWS, you can use the [JAWS hotkey
list](https://www.freedomscientific.com/training/jaws/hotkeys/) to
learn more quick keys.
...
- Control + F: Find text on the page
-   Insert + F7: Links List - lists page links
-   Insert + F6: List page headings
-   Insert + F5: List page forms
-   Ctrl + Home: Top of the page
-   Ctrl + End: Bottom of the Page
-   Alt + D, or Control + L: Browser address bar
